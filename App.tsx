    ...
    <div className={`min-h-screen flex flex-col items-center p-6 md:p-12 ${lang === 'ar' ? 'font-ar' : 'font-en'}`}>
      ...
      <footer className="w-full max-w-lg py-16 flex flex-col items-center gap-10 mt-auto">
        <div className="flex gap-12 justify-center">
          <a href="https://instagram.com/ajdel.sa" target="_blank" rel="noopener noreferrer" className="text-[#012842] opacity-40 hover:opacity-100 hover:scale-125 transition-all duration-300">
          ...
          <a href="https://tiktok.com/@ajdel.sa" target="_blank" rel="noopener noreferrer" className="text-[#012842] opacity-40 hover:opacity-100 hover:scale-125 transition-all duration-300">
            <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z"/>
            </svg>
          </a>
          <a href="https://snapchat.com/add/ajdel.sa" target="_blank" rel="noopener noreferrer" className="text-[#012842] opacity-40 hover:opacity-100 hover:scale-125 transition-all duration-300">
            <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
