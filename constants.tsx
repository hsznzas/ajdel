...
export const LINKS: ExtendedLinkItem[] = [
  { id: 'hunger', label: { ar: 'هنقرستيشن', en: 'HungerStation' }, url: 'https://hungerstation.com/sa-ar/restaurant/156422', deepLink: 'hungerstation://?c=SA&s=l&vt=local_shop&sid=87662&adj_t=1sdna162_1sy24r80', shimmerClass: 'btn-hunger', icon: '/images/LINK_HungerStation.png' },
  ...
  { id: 'keeta', label: { ar: 'كيتا', en: 'Keeta' }, url: 'https://url-sa.mykeeta.com/shop/1430269163', deepLink: 'keeta://shop/1430269163', shimmerClass: 'btn-chefz', icon: '/images/LINK_Keeta.png' },
